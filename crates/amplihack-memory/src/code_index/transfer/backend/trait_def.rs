use super::super::*;
use crate::code_index::BackendChoice;
use anyhow::Result;

/// Maximum allowed JSON file size for graph-db imports: 500 MiB.
/// Mirrors the same guard in the SQLite backend.
pub(in crate::code_index::transfer) const MAX_JSON_FILE_SIZE: u64 = 500 * 1024 * 1024;

pub(in crate::code_index::transfer) trait HierarchicalTransferBackend {
...
pub(in crate::code_index::transfer) struct GraphDbHierarchicalTransferBackend;

pub(in crate::code_index::transfer) fn open_hierarchical_transfer_backend_for(
...
pub(in crate::code_index::transfer) fn export_hierarchical_json(
    agent_name: &str,
    output: &str,
    storage_path: Option<&str>,
    choice: BackendChoice,
...
pub(in crate::code_index::transfer) fn import_hierarchical_json(
    agent_name: &str,
    input: &str,
    merge: bool,
    storage_path: Option<&str>,
...
pub(in crate::code_index::transfer) fn export_hierarchical_raw_db(
    agent_name: &str,
    output: &str,
    storage_path: Option<&str>,
    choice: BackendChoice,
...
pub(in crate::code_index::transfer) fn import_hierarchical_raw_db(
    agent_name: &str,
    input: &str,
    merge: bool,
    storage_path: Option<&str>,
