...
use crate::code_index::transfer::backend::open_hierarchical_transfer_backend_for;
use crate::code_index::transfer::{HierarchicalExportData, HierarchicalStats, ImportResult};
use amplihack_utils::test_env::home_env_lock;
use std::fs;
...
fn import_json_round_trip_sqlite() -> anyhow::Result<()> {
    ...
    let data = HierarchicalExportData {
        ...
        exported_at: "1704067200".to_string(),
        format_version: "1.1".to_string(),
        semantic_nodes: vec![crate::code_index::transfer::SemanticNode {
...
fn assert_derives_from_edge_preserved(choice: BackendChoice) -> anyhow::Result<()> {
    ...
    let data = HierarchicalExportData {
        ...
        episodic_nodes: vec![crate::code_index::transfer::EpisodicNode {
        ...
        similar_to_edges: vec![],
        derives_from_edges: vec![crate::code_index::transfer::DerivesEdge {
