pub(in crate::code_index::code_graph) const GRAPH_CODE_GRAPH_SCHEMA: &[&str] = &[
...
pub(in crate::code_index::code_graph) const GRAPH_MEMORY_FILE_LINK_TABLES: &[(&str, &str)] = &[
...
pub(in crate::code_index::code_graph) const GRAPH_MEMORY_FUNCTION_LINK_TABLES: &[(&str, &str)] = &[
